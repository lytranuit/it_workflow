<template>
    <div id="popup-require-sign">
        <div id="myModal-require-sign" class="modal" tabindex="-1" role="dialog" :data-backdrop="checkModal()">
                        ...
                        <div class="row">
                            <form id="form-require-sign" class="col-12">
                                <div class="row bg-white flex-m">
                                    ...
                                    <div class="col-9">
                                        <treeselect multiple v-model="listusersign" :options="users" name="user_sign" required />
                                    </div>
                                </div>
                            </form>
                        </div>
