<template>
	<div class="toolbar" :class="{'text-center':mode == 'executing'}">
		...
		<template v-if="mode == 'executing'">
			<span class="separator" />
			<el-tooltip :content="this.i18n['tooltip.allFlow']" placement="bottom">
				<span class="command" data-command="allFlow">
					<i class="fas fa-wind"></i>
				</span>
			</el-tooltip>
			<el-tooltip :content="this.i18n['tooltip.successFlow']" placement="bottom">
				<span class="command" data-command="successFlow">
					<i class="fas fa-grip-lines"></i>
				</span>
			</el-tooltip>
			<el-tooltip :content="this.i18n['tooltip.currentFlow']" placement="bottom">
				<span class="command" data-command="currentFlow">
