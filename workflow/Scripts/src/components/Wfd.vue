<template>
    ...
    <div class="root">
            ...
            <div style="display: flex">
                <ItemPanel ref="addItemPanel" v-if="!isView" :height="height" :model="data.model" :groups="groups" />
                <div ref="canvas" class="canvasPanel" :style="{'height':height+'px','width':isView?'100%':'65%','border-bottom':isView?0:null}"></div>
            ...
            initEvents() {
                ...
                this.graph.on('afterupdateitem', (items) => {
                    ...
                    if (cfg.x || cfg.y) {
                        ...
                        console.log(that.data.nodes[index]);
                    }
                });
