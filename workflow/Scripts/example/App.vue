	...
	export default {
		...
		data() {
			...
			return {
				...
				demoData: {
					nodes: [
						{ id: startNode1, process_id: new_process_id, x: 50, y: 200, label: 'Bắt đầu', clazz: 'start', type_performer: 1, },
						{ id: taskNode1, process_id: new_process_id, x: 300, y: 200, label: 'Biểu mẫu', clazz: 'formTask', type_performer: 1, data_setting: {}, fields: [] },
						{ id: taskNode2, process_id: new_process_id, x: 500, y: 200, label: 'Phê duyệt', clazz: 'approveTask', type_performer: 1, data_setting: {} },
						{ id: successNode, process_id: new_process_id, x: 800, y: 200, label: 'Hoàn thành', clazz: 'success', type_performer: 1, },
						{ id: failNode, process_id: new_process_id, x: 800, y: 320, label: 'Thất bại', clazz: 'fail', type_performer: 1 }
					],
					edges: [
						{ id: rand(), process_id: new_process_id, source: startNode1, target: taskNode1, sourceAnchor: 1, targetAnchor: 3, clazz: 'flow' },
						{ id: rand(), process_id: new_process_id, source: taskNode1, target: taskNode2, sourceAnchor: 1, targetAnchor: 3, clazz: 'flow' },
						{ id: rand(), process_id: new_process_id, source: taskNode2, target: successNode, sourceAnchor: 1, targetAnchor: 3, clazz: 'flow', label: 'yes' },
						{ id: rand(), process_id: new_process_id, source: taskNode2, target: failNode, sourceAnchor: 2, targetAnchor: 2, clazz: 'flow', label: 'no', reverse: true },
					],
					model: {
						id: new_process_id,
						group_id: 1,
