        ...
        <div class="layout-topbar-menu" :class="topbarMenuClasses">
            <div class="dropdown">
                <a class="nav-link dropdown-toggle waves-effect waves-light" data-toggle="dropdown"
                    ...
                    v-if="curentLang == 'en'">
                    English <img src="../assets/images/us_flag.jpg" class="ml-2" height="16" alt=""> <i
                        class="mdi mdi-chevron-down"></i>
                </a>
                <a class="nav-link dropdown-toggle waves-effect waves-light" data-toggle="dropdown"
                    href="javascript: void(0);" role="button" aria-haspopup="false" aria-expanded="false"
                    v-if="curentLang == 'vi'">
                    Tiếng việt <img src="../assets/images/vi_flag.png" class="ml-2" height="16" alt=""> <i
                        class="mdi mdi-chevron-down"></i>
                </a>
                <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end"
                    style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(1314px, 70px, 0px);">
                    <a class="dropdown-item" href="javascript: void(0);" @click="changeLanguage('en')"><span> English
                        </span><img src="../assets/images/us_flag.jpg" alt="" class="ml-2 float-right" height="14"></a>
                    <a class="dropdown-item" href="javascript: void(0);" @click="changeLanguage('vi')"><span> Tiếng Việt
                        </span><img src="../assets/images/vi_flag.png" alt="" class="ml-2 float-right" height="14"></a>
                </div>
            </div>
