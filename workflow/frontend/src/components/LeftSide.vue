        ...
        <ul class="nav-second-level" aria-expanded="false">
          ...
          <li class="nav-item">
            <router-link class="nav-link" to="/department"
              ><i class="ti-control-record"></i>Bộ phận</router-link
            >
          </li>
          <li class="nav-item">
            <router-link class="nav-link" to="/processgroup"
              ><i class="ti-control-record"></i>Nhóm quy trình</router-link
            >
          </li>
          <li class="nav-item">
            <router-link class="nav-link" to="/process"
              ><i class="ti-control-record"></i>Quy trình</router-link
            >
          </li>
        </ul>
      </li>
