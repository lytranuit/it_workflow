...
export default {
  ...
  mounted() {
    ...
    if (this.model.clazz == "formTask" || this.model.clazz == "approveTask") {
      this.data.push({
    ...
    for (var node of prev_nodes) {
      ...
      this.data.push({
        ...
        type: "employee",
        group: label,
        id: "created_by_name_" + node.variable,
      });
      this.data.push({
    ...
    var mail = $.extendext(
      true,
      "replace",
      { to: "!#created_by_name#", title: "", content: "", filecontent: "" },
      this.model.data_setting.mail
    );
  ...
  methods: {
    ...
    save_settings() {
      this.model.data_setting.mail = $.extendext(
        true,
        "replace",
        {},
        this.mail
