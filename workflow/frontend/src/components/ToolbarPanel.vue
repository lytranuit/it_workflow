  ...
  <div class="toolbar" :class="{ 'text-center': mode == 'executing' }">
    <template v-if="mode == 'edit'">
      <span
        ...
        data-command="undo"
        v-tooltip.bottom="$t('tooltip.undo')"
        placeholder="Bottom"
      >
      ...
      <span
        class="el-tooltip command"
        data-command="redo"
        v-tooltip.bottom="$t('tooltip.redo')"
        placeholder="Bottom"
      >
      ...
      <span
        class="el-tooltip command"
        data-command="copy"
        v-tooltip.bottom="$t('tooltip.copy')"
        placeholder="Bottom"
      >
      ...
      <span
        class="command"
        data-command="paste"
        v-tooltip.bottom="$t('tooltip.paste')"
        placeholder="Bottom"
      >
      ...
      <span
        class="command"
        data-command="delete"
        v-tooltip.bottom="$t('tooltip.delete')"
        placeholder="Bottom"
      >
    ...
    <span
      class="command"
      data-command="zoomIn"
      v-tooltip.bottom="$t('tooltip.zoomIn')"
      placeholder="Bottom"
    >
    ...
    <span
      ...
      v-tooltip.bottom="$t('tooltip.zoomOut')"
      placeholder="Bottom"
    >
    ...
    <span
      ...
      v-tooltip.bottom="$t('tooltip.zoomReset')"
      placeholder="Bottom"
    >
    ...
    <span
      ...
      v-tooltip.bottom="$t('tooltip.autoFit')"
      placeholder="Bottom"
    >
    ...
    <template v-if="mode == 'executing'">
      ...
      <span
        ...
        v-tooltip.bottom="$t('tooltip.allFlow')"
        placeholder="Bottom"
      >
      ...
      <span
        ...
        v-tooltip.bottom="$t('tooltip.successFlow')"
        placeholder="Bottom"
      >
      ...
      <span
        ...
        v-tooltip.bottom="$t('tooltip.currentFlow')"
        placeholder="Bottom"
      >
