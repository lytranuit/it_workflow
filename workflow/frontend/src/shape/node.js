...
const nodeDefinition = {
  ...
  drawStt(cfg, group) {
    ...
    const labelBBox = shape.getBBox();
    group.stt = group.addShape("text", {
      attrs: {
        fontSize: 12,
        fill: "#000",
        textAlign: "center",
  ...
  afterUpdate(cfg, group) {
    ...
    const stt = group.get("group").stt;
    stt.remove();
    this.drawStt(cfg, group.get("group"));
  },
};
